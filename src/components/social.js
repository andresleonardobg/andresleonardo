Vue.component('social',{
    ...
    <ul class="nav justify-content-center">
        <li class="bnav-item">
            <a href="https://twitter.com/AndresLeoBG" class="nav-link text-white" target="_blank"><i class="fab fa-twitter fa-lg"></i></a>
        </li>
        <li class="bnav-item">
            <a href="https://github.com/andresleonardobg" class="nav-link text-white" target="_blank"><i class="fab fa-github fa-lg"></i></i></a>
        </li>
        <li class="bnav-item">
            <a href="https://soundcloud.com/andres-leonardo-bg" class="nav-link text-white" target="_blank"><i class="fab fa-soundcloud fa-lg"></i></i></a>
        </li>
        <li class="bnav-item">
